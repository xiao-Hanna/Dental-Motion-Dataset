...
model = dict(
    ...
    backbone=dict(
        ...
        arch=dict(embed_dims=384, num_layers=12, num_heads=12, feedforward_channels=1536),
        img_size=(256, 192),
        patch_size=16,
...
metainfo = dict(
    ...
    keypoint_info=dict({
        i: dict(name=f'kpt_{i}', id=i, color=[255, 0, 0], type='upper', swap='')
...
# ===================== hooks =====================
default_hooks = dict(
    checkpoint=dict(type='CheckpointHook', interval=10, save_best='coco/AP'),
